...
At this point, your `id_rsa.pub` key has been uploaded to the remote account. You can continue on to [Step 3](how-to-set-up-ssh-keys-on-centos7#step-3-%E2%80%94-authenticate-to-your-centos-server-using-ssh-keys).
